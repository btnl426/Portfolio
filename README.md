...
## :pushpin: Intro
(여기에 자기 소개)
안녕하세요, 성실함을 가장 큰 덕목으로 여기는 개발자 곽진규입니다. 항상 정직하고 꾸준한 태도로 모든 프로젝트에 임하는 것을 중요시합니다. 저는 기술적 문제 해결을 위해 지속적으로 새로운 기술을 학습하며, 그 과정에서 팀원들과의 협력을 가장 중요하게 생각합니다. 이러한 저의 성실함은 프로젝트를 성공으로 이끄는 원동력이 되어왔습니다.
